"""
Django settings for generaltech project.
...
ALLOWED_HOSTS = list(config.get('django','HOST').split(','))
...
WSGI_APPLICATION = 'generaltech.wsgi.application'
